...
$app-border: rgba(contrast-yiq($app-bg, $gray-900), .15) !default;
...
// Widget
/// Background color of a component.
/// @deprecated Will be removed in v5. Use `$component-bg` variable instead.
/// @group component
$widget-bg: $component-bg !default;
/// Text color of a component.
/// @deprecated Will be removed in v5. Use `$component-text` variable instead.
/// @group component
$widget-text: $component-text !default;
/// Border color of a component.
/// @deprecated Will be removed in v5. Use `$component-border` variable instead.
/// @group component
...
$message-box-link-font-style: normal !default;
...
$form-hint-font-style: normal !default;
...
$input-focused-border: try-lighten( $primary, 25 ) !default;
$input-focused-shadow: 0 0 0 .2rem rgba($input-focused-border, .5) !default;

$input-placeholder-text: #6c757d !default;
...
$checkbox-bg: $custom-control-indicator-bg !default;
$checkbox-text: transparent !default;
$checkbox-border: $custom-control-indicator-border-color !default;
$checkbox-hovered-bg: $checkbox-bg !default;
$checkbox-hovered-text: $checkbox-text !default;
$checkbox-hovered-border: $checkbox-border !default;
$checkbox-checked-bg: $custom-control-indicator-checked-bg !default;
$checkbox-checked-text: $custom-control-indicator-checked-color !default;
$checkbox-checked-border: $custom-control-indicator-checked-border-color !default;
$checkbox-indeterminate-bg: $custom-checkbox-indicator-indeterminate-bg !default;
$checkbox-indeterminate-text: $custom-checkbox-indicator-indeterminate-color !default;
$checkbox-indeterminate-border: $custom-checkbox-indicator-indeterminate-border-color !default;
$checkbox-focused-border: $custom-control-indicator-focus-border-color !default;
$checkbox-focused-shadow: $custom-control-indicator-focus-box-shadow !default;
$checkbox-focused-checked-border: $checkbox-checked-border !default;
$checkbox-focused-checked-shadow: $custom-control-indicator-focus-box-shadow !default;
...
$checkbox-list-margin: 0 !default;
$checkbox-list-padding: 0 !default;
$checkbox-list-item-margin-top: 16px !default;
...
$radio-list-margin: 0 !default;
$radio-list-padding: 0 !default;
$radio-list-item-margin-top: 16px !default;
...
$listbox-bg: $panel-bg !default;
$listbox-text: $panel-text !default;
$listbox-border: $panel-border !default;
...
$slider-selection-bg: $progress-bar-bg !default;
...
$menu-text: $header-text !default;
$menu-border: $header-border !default;
$menu-gradient: null !default;

$menu-item-padding-x: $navbar-nav-link-padding-x !default;
...
$menu-scroll-button-border: $menu-border !default;
$menu-scroll-button-gradient: null !default;

$menu-scroll-button-hover-bg: null !default;
$menu-scroll-button-hover-text: rgba( $menu-text, .7 ) !default;
...
$menu-popup-item-spacing: 0 !default;
...
$toolbar-button-inner-calc-size: calc( #{$toolbar-button-line-height * 1em} + #{$toolbar-button-padding-y * 2} ) !default;

$toolbar-inner-calc-size: calc( #{$toolbar-button-line-height * 1em} + #{$toolbar-button-padding-y * 2} + #{$toolbar-button-border-width * 2} + #{$toolbar-padding-y * 2} ) !default;
...
$upload-dropzone-text: darken($component-bg, 27%) !default;
$upload-dropzone-text-opacity: null !default;
$upload-dropzone-border: $toolbar-border !default;
$upload-dropzone-hover-bg: try-shade( $upload-dropzone-bg, .2) !default;

$upload-item-padding-x: $spacer !default;
$upload-item-padding-y: $spacer !default;
...
$upload-icon-color: darken($component-bg, 27%) !default;
...
// Upload external DropZone
$external-dropzone-padding-x: $upload-dropzone-padding-x !default;
$external-dropzone-padding-y: $upload-dropzone-padding-y * 13 !default;
$external-dropzone-spacing: 8px !default;

$external-dropzone-bg: $upload-dropzone-bg !default;
$external-dropzone-text: $toolbar-text !default;
$external-dropzone-border: $upload-dropzone-border !default;

$external-dropzone-icon-opacity: null !default;
...
// Dialog
$dialog-titlebar-bg: null !default;
$dialog-titlebar-text: null !default;
$dialog-titlebar-border: null !default;
...
$notification-info-bg: tint($info, 10) !default;
$notification-info-text: shade($info, 6) !default;
$notification-info-border: tint($info, 9) !default;
$notification-success-bg: tint($success, 10) !default;
$notification-success-text: shade($success, 6) !default;
$notification-success-border: tint($success, 9) !default;
$notification-warning-bg: tint($warning, 10) !default;
$notification-warning-text: shade($warning, 6) !default;
$notification-warning-border: tint($warning, 9) !default;
$notification-error-bg: tint($error, 10) !default;
$notification-error-text: shade($error, 6) !default;
$notification-error-border: tint($error, 9) !default;
...
// Tooltip
$tooltip-padding-y: $tooltip-padding-y !default;
$tooltip-padding-x: $tooltip-padding-x !default;
$tooltip-max-width: $tooltip-max-width !default;
$tooltip-border-width: 0 !default;
$tooltip-border-radius: $tooltip-border-radius !default;

$tooltip-font-family: $font-family !default;
$tooltip-font-size: $tooltip-font-size !default;
...
$breadcrumb-border-width: 0 !default;
...
$breadcrumb-bg: $breadcrumb-bg !default;
...
$pager-item-border-radius: $border-radius !default;
$pager-item-spacing: (-1 * $pager-item-border-width) !default;

$pager-item-bg: $pagination-bg !default;
$pager-item-text: $pagination-color !default;
$pager-item-border: $pagination-border-color !default;

$pager-item-hover-bg: $pagination-hover-bg !default;
$pager-item-hover-text: $pagination-color !default;
$pager-item-hover-border: $pagination-hover-border-color !default;

$pager-item-selected-bg: $pagination-active-bg !default;
$pager-item-selected-text: $pagination-active-color !default;
$pager-item-selected-border: $pagination-active-border-color !default;
...
$pager-number-border-radius: 0 !default;
...
$stepper-border-width: 0 !default;
...
$stepper-indicator-bg: $component-bg !default;
...
$stepper-indicator-disabled-bg: $stepper-indicator-bg !default;
$stepper-indicator-disabled-text: mix($stepper-indicator-text, #ffffff, 60%) !default;
$stepper-indicator-disabled-border: $stepper-indicator-border !default;
...
$stepper-label-text: $component-text !default;
$stepper-label-success-text: $success !default;
$stepper-label-error-text: $error !default;
$stepper-label-hover-text: darken($body-text, 13%) !default;
$stepper-label-disabled-text: mix($component-text, #ffffff, 60%) !default;

$stepper-optional-label-opacity: .35 !default;
$stepper-disabled-opacity: .6 !default;
...
/// @group grid
$grid-alt-bg: $table-accent-bg !default;
...
/// @group grid
$grid-hovered-bg: $table-hover-bg !default;
/// Text color of hovered rows in grid
/// @group grid
$grid-hovered-text: $table-hover-color !default;
...
$grid-sticky-bg: try-shade($grid-bg, .5) !default;
$grid-sticky-text:  $grid-text !default;
$grid-sticky-border:  try-darken($grid-border, 5%) !default;

$grid-sticky-alt-bg: try-shade( true-mix($grid-alt-bg, $grid-bg, 6%), .5) !default;

$grid-sticky-header-bg: try-shade($grid-header-bg, .5) !default;
$grid-sticky-header-text: $grid-header-text !default;
$grid-sticky-header-border: $grid-sticky-border !default;

$grid-sticky-footer-bg: $grid-bg !default;
$grid-sticky-footer-hovered-bg: true-mix($grid-hovered-bg, $grid-sticky-footer-bg, 7%) !default;

$grid-sticky-selected-bg: try-shade( mix( $grid-bg, $selected-bg, 75% ), .5) !default;
$grid-sticky-selected-alt-bg:  try-shade( mix( mix( $grid-bg, contrast-wcag( $grid-bg ), 97% ), $selected-bg, 75% ), .5 ) !default;

$grid-sticky-hovered-bg: try-shade( true-mix($grid-hovered-bg, $grid-bg, 13%), .5) !default;
$grid-sticky-selected-hovered-bg: try-shade( mix( mix( $grid-bg, contrast-wcag( $grid-bg ), 93.5% ), $selected-bg, 75% ), .5) !default;
...
$pivotgrid-alt-color: null !default;
$pivotgrid-alt-text: null !default;
$pivotgrid-chrome-border: $border-color !default;

$pivotgrid-setting-delete-color: null !default;
...
$gantt-task-template-padding: $padding-y-sm $padding-x-sm !default;
...
$scheduler-nonwork-bg: try-shade( $component-bg, .5 ) !default;
...
$chat-alt-bubble-selected-shadow: none !default;
...
$chat-toolbar-box-bg: $toolbar-bg !default;
$chat-toolbar-box-text: $toolbar-text !default;
$chat-toolbar-box-border: inherit !default;
...
$typography-config: map-merge((
    display-1: font-map($headings-font-family, $display1-font-size, $display-line-height, $display1-weight ),
    display-2: font-map($headings-font-family, $display2-font-size, $display-line-height, $display2-weight ),
    display-3: font-map($headings-font-family, $display3-font-size, $display-line-height, $display3-weight ),
    display-4: font-map($headings-font-family, $display4-font-size, $display-line-height, $display4-weight ),
    h1: font-map($headings-font-family, $h1-font-size, $headings-line-height, $headings-font-weight ),
    h2: font-map($headings-font-family, $h2-font-size, $headings-line-height, $headings-font-weight ),
    h3: font-map($headings-font-family, $h3-font-size, $headings-line-height, $headings-font-weight ),
    h4: font-map($headings-font-family, $h4-font-size, $headings-line-height, $headings-font-weight ),
    h5: font-map($headings-font-family, $h5-font-size, $headings-line-height, $headings-font-weight ),
    h6: font-map($headings-font-family, $h6-font-size, $headings-line-height, $headings-font-weight ),
    body: font-map($font-family-base, $font-size-base, $line-height-base, $font-weight-base )
), $typography-config);
$typography-config: map-merge((
